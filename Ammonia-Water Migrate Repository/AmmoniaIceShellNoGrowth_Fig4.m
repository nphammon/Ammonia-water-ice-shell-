...
Hinit=0.4e0; %Non dimensional initial thickness of ice shell
H=Hinit;
...
%%% IMPORTANT: Define surface temperature as depth at 6 km to focus
%%% elements on partial melt region. 

Ts=165; %Surface Temparature
Tm=250;
Cp=1600;
kk=3;
rho=920;
